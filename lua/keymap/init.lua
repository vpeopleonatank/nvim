...
local plug_map = {
    ...
    ["n|<Leader>it"]      = map_cmd(":lua require'nvim-tree.view'.View.width = "):with_noremap(),
    ...
    ["n|<Leader>fna"]     = map_cu('Telescope line_notes'):with_noremap():with_silent(),
    ["n|<Leader>fnp"]     = map_cu('Telescope line_notes_project'):with_noremap():with_silent(),
