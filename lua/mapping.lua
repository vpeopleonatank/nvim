...
function mapping:load_plugin_define()
  self.plugin = {
    ...
    ["n|<Leader>fa"]     = map_cu('TelescopeLiveGrep'):with_noremap():with_silent(),
    ["n|<Leader>ff"]     = map_cu('TelescopeFindFile'):with_noremap():with_silent(),
    ["n|<Leader>fg"]     = map_cu('TelescopeGitFile'):with_noremap():with_silent(),
    ["n|<Leader>fw"]     = map_cu('lua require("telescope.builtin").grep_string{search = false}'):with_noremap():with_silent(),
    ["n|<Leader>fo"]     = map_cu('TelescopeOldFiles'):with_noremap():with_silent(),
    ["n|<Leader>fh"]     = map_cu('TelescopeHelpTags'):with_noremap():with_silent(),
    ["n|<Leader>fl"]     = map_cu('TelescopeLoclist'):with_noremap():with_silent(),
